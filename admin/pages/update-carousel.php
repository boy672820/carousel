<div class="wrap">
	...
	<h1 class="wp-heading-inline">슬라이더 수정</h1>
	...
	<form action="" class="carousel form slider">
		...
		<input type="hidden" name="action" value="carousel_update_slider">
		<input type="hidden" name="nonce" value="<?php echo wp_create_nonce( 'update-carousel' ) ?>">

		<input type="hidden" name="id" value="<?php echo $id ?>">

		<input type="hidden" id="slides_action" value="carousel_update_slides">

		<table class="form-table">
			<tbody>
				<tr>
					<th><label for="name">이름</label></th>
					<td><input type="text" name="name" id="name" value="<?php echo $slider_name ?>" placeholder="이름을 입력해주세요."></td>
				</tr>
			</tbody>
		</table><!-- //.form-table -->
		...
		<div class="media-frame wp-core-ui mode-grid mode-edit hide-menu">
			...
			<div class="media-frame-content" data-columns="10">
				...
				<ul tabindex="-1" class="attachments carousel slides list">
					...
					<li tabindex="0" role="button" aria-label="<?php echo $slide->title ?>" id="carousel-slide-<?php echo $slide->slide_order ?>" class="attachment carousel slides item" data-slide-id="<?php echo $slide->ID ?>" data-slide-order="<?php echo $slide->slide_order ?>" data-image-url="<?php echo $slide->image_url ?>" data-title="<?php echo $slide->title ?>" data-link="<?php echo $slide->link ?>">
...
<div class="carousel modal wrap">
	...
	<div class="carousel modal popup">
		...
		<form action="" class="carousel form slide" data-action="create">
